      ...
      <div className="row align-items-center">
        <div className="col-auto pr-5" style={{ width: 530 }}>
          <h1 className="font-weight-bold line-height-1 mb-3">
            Find traditional <br />
            healing methods here
          </h1>
          <p
            className="mb-4 font-weight-light text-gray-500 w-75"
            style={{ lineHeight: "170%" }}
          >
            Hey, welcome to Herb Website. You can find information about herbal
            plants related to your health. Let’s get your healthy life with us!
          </p>
          <Button
            className="btn px-5"
            hasShadow
